...
//altmem_init CBX_AUTO_BLACKBOX="ALL" DEVICE_FAMILY="Cyclone IV E" INIT_FILE="inst2.mif" INIT_TO_ZERO="NO" NUMWORDS=16384 PORT_ROM_DATA_READY="PORT_UNUSED" ROM_READ_LATENCY=1 WIDTH=32 WIDTHAD=14 clock dataout init init_busy ram_address ram_wren
...
module  ram_initializer2_meminit_s7m
	( 
	clock,
	dataout,
	init,
	...
	defparam
		int_rom.init_file = "inst2.mif",
		int_rom.numwords_a = 16384,
		int_rom.operation_mode = "ROM",
		int_rom.width_a = 32,
		int_rom.widthad_a = 14,
		int_rom.intended_device_family = "Cyclone IV E",
	...
	assign
		wire_delay_addr_ena = {14{(clken & rom_data_capture_state)}};
	// synopsys translate_off
	initial
		state_reg[0:0] = 0;
	// synopsys translate_on
...
endmodule //ram_initializer2_meminit_s7m
//VALID FILE
...
module ram_initializer2 (
	...
	ram_initializer2_meminit_s7m	ram_initializer2_meminit_s7m_component (
				.clock (clock),
				.init (init),
				.dataout (sub_wire0),
				.init_busy (sub_wire1),
