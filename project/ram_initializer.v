...
//altmem_init CBX_AUTO_BLACKBOX="ALL" DEVICE_FAMILY="Cyclone IV E" INIT_FILE="inst.mif" INIT_TO_ZERO="NO" NUMWORDS=16384 PORT_ROM_DATA_READY="PORT_UNUSED" ROM_READ_LATENCY=1 WIDTH=32 WIDTHAD=14 clock dataout init init_busy ram_address ram_wren
...
module  ram_initializer_meminit_a6m
	( 
	clock,
	dataout,
	init,
...
endmodule //ram_initializer_meminit_a6m
//VALID FILE
...
module ram_initializer (
	...
	ram_initializer_meminit_a6m	ram_initializer_meminit_a6m_component (
				.clock (clock),
				.init (init),
				.dataout (sub_wire0),
				.init_busy (sub_wire1),
